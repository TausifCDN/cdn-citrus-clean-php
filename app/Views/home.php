                ...
                <div class="col col-sm-12 col-md-6 col-lg-6 ">
                    <br/> <br/>
                     <form>
                        ...
                        <div class="btnss_inner">
                            <button type="submit" class="btn btn-success btn-md btn-block">Talk to a specialist</button>
                        </div>
    ...
    <section class="banner-inner">
        <div class="container" id="medi">
            <div class="banner-descrptions2 mobiles-view">
                <h6>Be a Hero today<br>for the problems of tomorrow</h6>
...
<div class="container">
    ...
    <section class="Our-package" id="section1">
        <div class="container">
            ...
            <br/>
            <h2 class="heading-inner-main">Citrus Man Industrial Product Line</h2>

            <div class="container">

                
                <?php for($in=2; $in<count($categories);$in+=3) { ?>
